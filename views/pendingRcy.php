...
<body>
    <div class="w-svw h-svh bg-[#FDE5D4] flex gap-1">
        <?php include "../src/admin/components/navigations/ewastePendingNav.php" ?>
        <div class="lg:w-[83%] w-full h-svh overflow-hidden">
            <div class="toast toast-end z-50" id="alertMsg">
            </div>
                <?php include '../src/admin/components/navigations/headerPendingRcy.php' ?>
            <div class="w-full contLstOvrf h-[100%] overflow-y-auto">
            <div class="w-full contLstOvrf h-[90%]  overflow-y-auto" id="ctyHtml">
                <?php include '../src/admin/components/fetching/pendRcyFetch/rcyItemFetch.php' ?>
            </div>
        </div>
        ...
        <dialog id="declineRcy" class="modal">
