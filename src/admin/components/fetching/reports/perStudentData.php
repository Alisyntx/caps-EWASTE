...
$queryStudents = "
    ...
    WHERE 
        h.hry_activity = 'Recycle Accepted'
    ORDER BY 
...
if ($resultStudents->num_rows > 0) {
    ...
    <head>
        ...
        <title>All Students' Recycled Items</title>
    </head>

    <body>
        <div class="w-full h-full p-4">
            <h1 class="text-2xl font-bold text-center mb-4">Recycled Items Per Student</h1>
            ...
            while ($student = $resultStudents->fetch_assoc()) {
                ...
                $queryItems = "SELECT hry_rcy_item AS item_name, hry_rcy_pts AS item_points, hry_refnum AS ref_num, hry_brand AS brand FROM tbl_rcnt_hry WHERE hry_user_id = ? AND hry_activity = 'Recycle Accepted'";
