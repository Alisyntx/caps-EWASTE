 <div class="lg:w-[17%]  h-screen rounded-md hidden bg-bgbox lg:flex items-center flex-col">
     ...
     <ul class="menu menu-sm w-full mt-9">
         ...
         <li>
             <details open>
                 <summary class="bg-white text-xs rounded-md mt-2 font-semibold font-popin items-center border border-bgborder btn-active btn-neutral">
                     <i data-lucide="warehouse" class="mr-5 w-5 h-5"></i>
                     <span class="">Storage </span>
                 </summary>
                 <ul>
                     <li class="mt-2">
                         <a href="ewstStorage.php" id="btncstm2" class="justify-start font-popin text-xs border">
                            <i class='bx bx-recycle text-[20px] mr-5'></i>
                             Ewaste Storage</a>
                     </li>
                     <li class="mt-2">
