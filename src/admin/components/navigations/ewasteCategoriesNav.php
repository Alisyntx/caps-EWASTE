 <div class="lg:w-[17%]  h-screen rounded-md hidden bg-sidenavbg lg:flex items-center flex-col">
     ...
     <ul class="menu menu-sm w-full mt-9">
         <li>
             <a href="adminDashboard.php" id="btncstm1" class="mt-2 text-xs justify-start flex btn-sm rounded-md font-semibold font-popin">
         ...
         <li>
             <details close>
                 <summary class=" bg-white text-xs rounded-md mt-2 font-semibold btn-active btn-neutral font-popin">
                 ...
                 <ul>
                     ...
                     <li class="mt-2">
                         <a id="btnAddItem" class="rounded-md justify-start text-xs font-popin">
         ...
         <li>
             <details close>
                 ...
                 <ul>
                     <li class="mt-2">
                         <a href="redemption.php" id="btncstm2" class="justify-start font-popin text-xs">
                             <i class='bx bx-category-alt mr-5 font-bold text-lg'></i>
                             Redemption items</a>
                     </li>
                     <li class="mt-2">
